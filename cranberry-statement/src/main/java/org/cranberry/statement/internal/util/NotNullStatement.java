 ...
 * @project cranberry
 * @created 2020 -03-09 20:21 <p>
 */
class NotNullStatement implements Statement {
    ...
    static void check(Object actual) {
        NotNullStatement.check(actual, null);
    }
    ...
    static void check(Object actual, String message) {
        if (NotNullStatement.Reasoner.isObjectNull(actual)) {
            throw new NotNullStatementException(message);
        }
    }
}
