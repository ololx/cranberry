 ...
 * are discouraged from using. It will be removed in a future version.
 *
 ...
 *
 * This annotation type has a string-valued elements {@code from}. The value of
 * this element indicates the version in which the annotated program element
 * will be removed.
 *
 * @apiNote
 ...
 *
 * It is recommended that a {@code from} value be provided with all newly
 * annotated program elements. Note that {@code from} may not be required as it
