 ...
 */
public class TrueAnnotationNegativeITest extends TrueAnnotationITest {
    ...
    /**
     * Method param true when boolean value is not true then do not throws exception.
     *
    ...
    public void methodParamTrue_whenBooleanValueIsNotTrue_thenDoNotThrowsException(Boolean value) {
        this.executeWithAnnotatedParam(value);
    }

    /**
     * Local variable true when boolean value is not true then do not throws exception.
     *
     * @param value the value
     */
    @Test(
