 ...
 */
public class StatementsStateNotNullNegativeUTest {
    ...
    /**
     * State not null when object value is null then throws exception.
     *
    ...
    public void stateNotNull_whenObjectValueIsNull_thenThrowsException(Object value) {
