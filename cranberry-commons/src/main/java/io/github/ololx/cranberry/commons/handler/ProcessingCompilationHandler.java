 ...
 */
public final class ProcessingCompilationHandler<T extends TaskEvent, K extends TaskEvent.Kind>
        extends AbstractCompilationHandler<T, K> {

    {
        this.phasesTypes = (Set<K>) Collections.singleton(TaskEvent.Kind.ANNOTATION_PROCESSING);
    }

    /**
     * Instantiates a new Enter compilation handler.
     */
    public ProcessingCompilationHandler() {
        super();
    }
}
